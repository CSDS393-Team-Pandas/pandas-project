    ...
    Editor.prototype.getBlocks = function (pasteContent, isPaste, sections, comments, revision) {
        ...
        if (typeof (pasteContent) === 'string') {
            ...
            if (pasteContent.lastParagraphMarkCopied) {
                var lastParagraphWidget = bodyWidget.childWidgets[bodyWidget.childWidgets.length - 1];
                if (lastParagraphWidget instanceof ParagraphWidget) {
                    if (lastParagraphWidget.childWidgets.length > 0) {
                        var lineWidget = lastParagraphWidget.childWidgets[lastParagraphWidget.childWidgets.length - 1];
                        var textElementBox = new TextElementBox();
                        textElementBox.text = '\v';
                        textElementBox.line = lineWidget;
                        lineWidget.children.push(textElementBox);
                    }
                    else if (bodyWidget.childWidgets[bodyWidget.childWidgets.length - 2] instanceof TableWidget) {
