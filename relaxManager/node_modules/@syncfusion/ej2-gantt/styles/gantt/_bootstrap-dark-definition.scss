...
$connector-point-hover-color: $grey-cc !default;
...
$gantt-unscheduled-taskbar-background-color: rgba($brand-primary, 0.2 ) !default;
...
$gantt-edit-icon-color: #fff !default;
...
$gantt-dialog-active-tab-background: #1a1a1a !default;
...
$gantt-dialog-close-icon-hover-color: #f0f0f0 !default;
