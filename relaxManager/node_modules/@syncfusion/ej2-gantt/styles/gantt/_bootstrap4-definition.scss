...
$connector-point-hover-bg-color: rgba($white, 1) !default;
...
$gantt-unscheduled-taskbar-background-color: rgba($primary, 0.2) !default;
...
$gantt-parent-task-bar: $gray-600 !default;
...
$gantt-dialog-active-tab-background: $white !default;
$gantt-dialog-tab-padding-left: 12px;
$gantt-dialog-tab-background: $primary !default;
$gantt-dialog-header-font-color: $white !default;
$gantt-dialog-icon-color: rgba($white, .75) !default;
$gantt-dialog-icon-hover-color: transparent !default;
$gantt-dialog-close-icon-hover-color: rgba($white, 1) !default;
...
$gantt-tab-header-hover-font-color: $white !default;
...
$gantt-baseline-color: $orange !default;
...
$gantt-header-border-height: 65px !default;
$gantt-treegrid-header-border-height: 63px !default;
$gantt-header-border-bottom-width: 2px !default;
